export default {
  ...
  markets: {
    ...
    details: {
      ...
      settleYes: 'Settle as Yes',
      settleNo: 'Settle as No',
      marketInfo: 'Market Information',
      notFound: 'Market not found',
      confirmSettle: 'Are you sure to settle the market as "{resolution}"? This action cannot be undone.',
    },
    status: {
      active: 'Active',
      resolved: 'Resolved',
  ...
  create: {
    ...
    form: {
      ...
      initialLiquidity: 'Initial Liquidity (Points)',
      liquidityPlaceholder: 'Deducted from balance as initial liquidity',
      initialPrice: 'Initial Price',
      liquidityHelp: 'Optional. Providing initial liquidity makes trading smoother. Set to 0 to not provide.',
      pleaseConnect: 'Please connect wallet first',
    },
    buttons: {
      create: 'Create Market',
