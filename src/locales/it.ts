export default {
  ...
  markets: {
    details: {
      ...
      yes: 'Sì',
      no: 'No',
      settleMarket: 'Liquidare mercato',
      settleYes: 'Liquidare come Sì',
      settleNo: 'Liquidare come No',
      marketInfo: 'Informazioni del mercato',
      notFound: 'Mercato non trovato',
      confirmSettle: 'Sei sicuro di liquidare il mercato come "{resolution}"? Questa azione non può essere annullata.',
      probability: 'Probabilità',
      currentProbability: 'Probabilità attuale',
      priceChart: 'Grafico dei prezzi',
      recentVotes: 'Voti recenti',
      votingArea: 'Area di voto',
      noVotes: 'Nessun record di voto',
      comments: 'Commenti',
      noComments: 'Nessun commento ancora',
      addComment: 'Aggiungi commento',
      commentPlaceholder: 'Condividi i tuoi pensieri...',
      pleaseConnect: 'Si prega di collegare prima il portafoglio',
  ...
  createMarket: {
    ...
    form: {
      ...
      endTime: 'Ora di Fine',
      submit: 'Crea Mercato',
      initialLiquidity: 'Liquidità iniziale (Punti)',
      liquidityPlaceholder: 'Dedotto dal saldo come liquidità iniziale',
      initialPrice: 'Prezzo iniziale',
      liquidityHelp: 'Opzionale. Fornire liquidità iniziale rende il trading più fluido. Impostare a 0 per non fornire.',
    }
  },
